...
<model ref="r:5563dc37-9db2-4dbb-a901-1b0ac516aac8(org.modellwerkstatt.objectflow.tests.conv)">
  ...
  <node concept="2WPaUQ" id="16YJG28qXXm">
        ...
        <node concept="3cpWs8" id="6MByTIyrFBL" role="3cqZAp">
          <node concept="3cpWsn" id="6MByTIyrFBM" role="3cpWs9">
            ...
            <node concept="2YIFZM" id="6MByTIyrFBQ" role="33vP2m">
              ...
              <node concept="10M0yZ" id="6MByTIyrGO$" role="37wK5m">
                <ref role="3cqZAo" to="18b:3wl_P2NF_Mk" resolve="CONV_DEFAULT_EN" />
                <ref role="1PxDUh" to="18b:6qNJO0Imc8R" resolve="CONV" />
              </node>
    ...
    <node concept="3yPF9F" id="7_PeuXFoMYo" role="3yMuLx">
      ...
      <node concept="3clFbS" id="7_PeuXFoMYq" role="3clF47">
        ...
        <node concept="1gVbGN" id="7_PeuXFqDOJ" role="3cqZAp">
          <node concept="2OqwBi" id="7_PeuXFqEdx" role="1gVkn0">
            <node concept="37vLTw" id="7_PeuXFqDXM" role="2Oq$k0">
              <ref role="3cqZAo" node="7_PeuXFoMYP" resolve="st" />
            </node>
            <node concept="liA8E" id="7_PeuXFqEmF" role="2OqNvi">
              <ref role="37wK5l" to="wyt6:~String.equals(java.lang.Object)" resolve="equals" />
              <node concept="1WHerN" id="7_PeuXFqEta" role="37wK5m">
                <property role="1WHdSU" value="5tU8YWFO8zP/XML" />
                <node concept="37vLTw" id="7_PeuXFqEw5" role="1WEEMK">
                  <ref role="3cqZAo" node="7_PeuXFoMYK" resolve="entity" />
                </node>
              </node>
            </node>
  ...
  <node concept="34Athd" id="7_PeuXE_0z0">
    ...
    <node concept="1bOX9e" id="6MByTIy$nF7" role="TxmiU">
      <property role="2RkwnN" value="parent2" />
      <node concept="3Tm1VV" id="6MByTIy$nF8" role="1B3o_S" />
      <node concept="2RoN1w" id="6MByTIy$nF9" role="2RnVtd">
        <node concept="3wEZqW" id="6MByTIy$nFa" role="3wFrgM" />
        <node concept="3xqBd$" id="6MByTIy$nFb" role="3xrYvX">
          <node concept="3Tm1VV" id="6MByTIy$nFc" role="3xqFEP" />
        </node>
      </node>
      <node concept="3uibUv" id="6MByTIy$nFd" role="2RkE6I">
        <ref role="3uigEE" node="16YJG28Jyx5" resolve="MyE" />
      </node>
    </node>
  </node>

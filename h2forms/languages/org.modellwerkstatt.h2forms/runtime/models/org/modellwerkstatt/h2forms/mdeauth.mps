      ...
      <node concept="3clFbS" id="4Rlyz3E6FEr" role="3clF47">
        ...
        <node concept="3clFbJ" id="7Xjd0MaCbnW" role="3cqZAp">
          ...
          <node concept="3eNFk2" id="7Xjd0MaCdUS" role="3eNLev">
            ...
            <node concept="22lmx$" id="1qs1YQQIct8" role="3eO9$A">
              <node concept="2OqwBi" id="7lr2Gyz8mgo" role="3uHU7B">
              ...
              <node concept="2OqwBi" id="1qs1YQQIczj" role="3uHU7w">
                <node concept="37vLTw" id="1qs1YQQIczk" role="2Oq$k0">
                  <ref role="3cqZAo" node="4Rlyz3E7gyZ" resolve="userAgent" />
                </node>
                <node concept="liA8E" id="1qs1YQQIczl" role="2OqNvi">
                  <ref role="37wK5l" to="wyt6:~String.contains(java.lang.CharSequence)" resolve="contains" />
                  <node concept="Xl_RD" id="1qs1YQQIczm" role="37wK5m">
                    <property role="Xl_RC" value="EB37" />
                  </node>
                </node>
              </node>
            </node>
          </node>
          <node concept="3eNFk2" id="1WUySaDvDDT" role="3eNLev">
            <node concept="3clFbS" id="1WUySaDvDDU" role="3eOfB_">
              <node concept="3clFbF" id="1WUySaDvDDV" role="3cqZAp">
                <node concept="37vLTI" id="1WUySaDvDDW" role="3clFbG">
                  <node concept="37vLTw" id="1WUySaDvDDX" role="37vLTJ">
                    <ref role="3cqZAo" node="4Rlyz3E6UWl" resolve="deviceSwDetected" />
                  </node>
                  <node concept="Rm8GO" id="1WUySaDvEq2" role="37vLTx">
                    <ref role="Rm8GQ" to="tea8:10YuSCZaxus" resolve="ZEBRAEB_32" />
                    <ref role="1Px2BO" to="tea8:1DW7q9hIaqF" resolve="ContextClient.DevicesSw" />
                  </node>
                </node>
              </node>
              <node concept="3clFbH" id="1WUySaDvDDZ" role="3cqZAp" />
            </node>
            <node concept="22lmx$" id="1WUySaDC0Kd" role="3eO9$A">
              <node concept="2OqwBi" id="1WUySaDvDE0" role="3uHU7B">
                <node concept="37vLTw" id="1WUySaDvDE1" role="2Oq$k0">
                  <ref role="3cqZAo" node="4Rlyz3E7gyZ" resolve="userAgent" />
                </node>
                <node concept="liA8E" id="1WUySaDvDE2" role="2OqNvi">
                  <ref role="37wK5l" to="wyt6:~String.contains(java.lang.CharSequence)" resolve="contains" />
                  <node concept="Xl_RD" id="1WUySaDvDE3" role="37wK5m">
                    <property role="Xl_RC" value="EB32" />
                  </node>
                </node>
              </node>
              <node concept="2OqwBi" id="10YuSCZawhN" role="3uHU7w">
          ...
          <node concept="3eNFk2" id="1qs1YQQIfHz" role="3eNLev">
            <node concept="3clFbS" id="1qs1YQQIfH$" role="3eOfB_">
              <node concept="3clFbF" id="1qs1YQQIfH_" role="3cqZAp">
                <node concept="37vLTI" id="1qs1YQQIfHA" role="3clFbG">
                  <node concept="37vLTw" id="1qs1YQQIfHB" role="37vLTJ">
                    <ref role="3cqZAo" node="4Rlyz3E6UWl" resolve="deviceSwDetected" />
                  </node>
                  <node concept="Rm8GO" id="1qs1YQQIghw" role="37vLTx">
                    <ref role="Rm8GQ" to="tea8:2kuDuEA0tcD" resolve="ZEBRAEB_20" />
                    <ref role="1Px2BO" to="tea8:1DW7q9hIaqF" resolve="ContextClient.DevicesSw" />
                  </node>
                </node>
              </node>
              <node concept="3clFbH" id="1qs1YQQIfHD" role="3cqZAp" />
            </node>
            <node concept="2OqwBi" id="1qs1YQQIfHE" role="3eO9$A">
              <node concept="37vLTw" id="1qs1YQQIfHF" role="2Oq$k0">
                <ref role="3cqZAo" node="4Rlyz3E7gyZ" resolve="userAgent" />
              </node>
              <node concept="liA8E" id="1qs1YQQIfHG" role="2OqNvi">
                <ref role="37wK5l" to="wyt6:~String.contains(java.lang.CharSequence)" resolve="contains" />
                <node concept="Xl_RD" id="1qs1YQQIfHH" role="37wK5m">
                  <property role="Xl_RC" value="EB2" />
                </node>
              </node>
            </node>
          </node>
          ...
          <node concept="3eNFk2" id="1WUySaDvEwc" role="3eNLev">
            <node concept="3clFbS" id="1WUySaDvEwd" role="3eOfB_">
              <node concept="3clFbF" id="1WUySaDvEwe" role="3cqZAp">
                <node concept="37vLTI" id="1WUySaDvEwf" role="3clFbG">
                  <node concept="Rm8GO" id="1WUySaDvEUO" role="37vLTx">
                    <ref role="Rm8GQ" to="tea8:10YuSCZaxus" resolve="ZEBRAEB_32" />
                    <ref role="1Px2BO" to="tea8:1DW7q9hIaqF" resolve="ContextClient.DevicesSw" />
                  </node>
                  <node concept="37vLTw" id="1WUySaDvEwh" role="37vLTJ">
                    <ref role="3cqZAo" node="4Rlyz3E6UWl" resolve="deviceSwDetected" />
                  </node>
                </node>
              </node>
              <node concept="3clFbH" id="1WUySaDvEwi" role="3cqZAp" />
            </node>
            <node concept="2OqwBi" id="1WUySaDvEwj" role="3eO9$A">
              <node concept="37vLTw" id="1WUySaDvEwk" role="2Oq$k0">
                <ref role="3cqZAo" node="4Rlyz3E7gyZ" resolve="userAgent" />
              </node>
              <node concept="liA8E" id="1WUySaDvEwl" role="2OqNvi">
                <ref role="37wK5l" to="wyt6:~String.contains(java.lang.CharSequence)" resolve="contains" />
                <node concept="Xl_RD" id="1WUySaDvEwm" role="37wK5m">
                  <property role="Xl_RC" value="TC26" />
                </node>
              </node>
            </node>
          </node>
            ...
            <node concept="3clFbS" id="7Xjd0MaCoFM" role="3eOfB_">
              <node concept="3clFbF" id="7Xjd0MaCoFN" role="3cqZAp">
                <node concept="37vLTI" id="7Xjd0MaCoFO" role="3clFbG">
                  <node concept="Rm8GO" id="1qs1YQQIcZe" role="37vLTx">
                    <ref role="Rm8GQ" to="tea8:7lr2Gyz8j3i" resolve="ZEBRAEB_35" />
                    <ref role="1Px2BO" to="tea8:1DW7q9hIaqF" resolve="ContextClient.DevicesSw" />
                  </node>
      ...
      <node concept="3clFbS" id="4W0T8adlZyI" role="3clF47">
        <node concept="3clFbJ" id="4W0T8admKTN" role="3cqZAp">
          <node concept="3clFbS" id="4W0T8admKTP" role="3clFbx">
            ...
            <node concept="3clFbH" id="1Ilg9xV6BpM" role="3cqZAp" />

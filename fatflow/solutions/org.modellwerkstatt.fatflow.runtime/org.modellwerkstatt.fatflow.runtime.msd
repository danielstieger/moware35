...
<solution name="org.modellwerkstatt.fatflow.runtime" uuid="994b0fbe-124d-4b44-9098-e2d97dd86f2a" moduleVersion="0" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mowareHome}/objectflow/languages/objectflow/jars/addons/mysql-connector-java-8.0.11.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
